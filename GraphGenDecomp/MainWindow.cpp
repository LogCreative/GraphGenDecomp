...
int main(int argc, char** argv) {
	...
	mainwin->begin();
	{
        Fl_Tabs* t = new Fl_Tabs(0, 0, WIDTH, HEIGHT);
        {
            ...
            G_Sfilename->tooltip("Choose the subgraph directory. Avoid using NON ASCII directory.");
            ...
            I_DecompAlg->tooltip("The hardness of dividing algorithm (Kerninghan-Lin). If it is set to from partition, you should leave partition.txt in the subgraph folder.");
            ...
            I_SubRaw->tooltip("If the subgraph files is the same format as the main file, which is not generated by this program, then you should check this box. This is only applied for CALC ONLY option.");
