...
int main(int argc, char** argv) {
	...
	mainwin->begin();
	{
        Fl_Tabs* t = new Fl_Tabs(0, 0, WIDTH, HEIGHT);
        {
            ...
            I_SubRaw = new Fl_Check_Button(butCheck->x(), butCheck->y() - MARGIN * 2.5, 100, 25, "Sub outsourced");
            I_SubRaw->tooltip("If the subgraph files is the same format as the main file, which is not generated by this program, then you should check this box. This is only applied to CHK ONLY option.");
